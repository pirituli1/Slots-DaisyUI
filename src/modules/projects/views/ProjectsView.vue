<template>
  ...
  <!-- <input-modal :open="modalOpen" @close="modalOpen = false" @value="onNewValue($event)" /> Si se utiliza solo el argumento es inecesario mandarle el event -->
  <input-modal
    :open="modalOpen"
...
import Modallcon from '@/modules/common/icons/Modallcon.vue';
